...
#define SMALL_ROLES list(/datum/job/tourist, /datum/job/local)
#define INDEP_ROLES list(/datum/job/merchant, /datum/job/local, /datum/job/consular, /datum/job/journalist)
#define ALL_FACTION_ROLES list(/datum/job/tourist, /datum/job/local, /datum/job/representative)
#define MISC_ROLE list(/datum/job/tourist, /datum/job/representative)
