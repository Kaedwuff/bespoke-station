/datum/trader
	...
	var/list/allowed_space_sectors = list(SECTOR_DESERT, SECTOR_ICYFOREST, SECTOR_CITYSCAPE, SECTOR_VALLEY_HALE, SECTOR_BADLANDS, SECTOR_NEW_ANKARA, SECTOR_AEMAQ, SECTOR_SRANDMARR, SECTOR_NRRAHRAHUL,
