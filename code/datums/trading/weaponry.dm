...
/datum/trader/ship/illegalgun
	...
	allowed_space_sectors = list(SECTOR_DESERT, SECTOR_CITYSCAPE, SECTOR_VALLEY_HALE, SECTOR_BADLANDS, SECTOR_NEW_ANKARA, SECTOR_AEMAQ, SECTOR_SRANDMARR, SECTOR_NRRAHRAHUL, SECTOR_GAKAL, SECTOR_UUEOAESA)
